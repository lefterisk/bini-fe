...
class Book extends record(defaults) {
    static fromJSON(json = {}) {
        return construct(Book, json, {
            ...
            prototype_author: resolve.as(List),
